...
### Digital WDR (DWDR)
- Xử lý phần mềm: Xử lý hậu kỳ trên 1 khung hình duy nhất (tone mapping), điều chỉnh độ sáng từng vùng pixel riêng biệt.
- Nhược điểm:
...
![Compare 1](/image/IoT/HDR_WDR/Compare_1.png)
...
![Compare 2](/image/IoT/HDR_WDR/Compare_2.png)
