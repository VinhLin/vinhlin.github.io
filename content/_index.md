...
## 👨‍💻 Dự án cá nhân: <mark>[HOMELAB Server](http://172.16.40.40:3000/)</mark>
...
- Xây dựng và triển khai **AI Assistant** *(trợ lý AI cá nhân)*, sử dụng mô hình dùng kết hợp giữa **OpenClaw** + **OpenAPI API** + **Telegram Bot**.
